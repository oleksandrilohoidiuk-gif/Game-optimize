...
router.post('/optimize', async (req, res) => {
       ...
       messages: [
  {
    ...
    6. Якщо гра відверто вигадана або залізо не є комп'ютером/консоллю (наприклад, "мікрохвильовка", "тостер") — відповідай: "Я не маю інформації про таку гру або платформу."
